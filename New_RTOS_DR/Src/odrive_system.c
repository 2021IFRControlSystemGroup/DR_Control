...
{
  TxMessageData_Add(_Axis->Instruction, 0, 0, 1);
  TxMessageHeader_Set(_Axis->Instruction, 0, 0, 0, 1, _Axis->StdID);
}
...
{
  TxMessageData_Add(_Axis->Instruction, (uint64_t)_Axis->Requested_State, 0, 1);
  TxMessageHeader_Set(_Axis->Instruction,4,0,0,0,_Axis->StdID);
}
...
{
  TxMessageData_Add(_Axis->TxMessage, *((uint64_t*)(&_Axis->Input_Vel)), 0, 3);
  TxMessageHeader_Set(_Axis->Instruction,4,0,0,0,_Axis->StdID);
}
